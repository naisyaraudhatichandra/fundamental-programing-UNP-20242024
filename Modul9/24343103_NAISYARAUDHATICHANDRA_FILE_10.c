...
int main() {
    ...
    FILE *inputFile = fopen("C:\\Users\\User\\OneDrive\\Documents\\fundamental programming\\input.txt", "r");
    if (inputFile == NULL) {
    ...
    FILE *outputFile = fopen("C:\\Users\\User\\OneDrive\\Documents\\fundamental programming\\output.txt", "w");
    if (outputFile == NULL) {
